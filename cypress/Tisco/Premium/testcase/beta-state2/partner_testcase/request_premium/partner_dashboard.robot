...
Dashboard_VerifyValueflow(Partner) - ตรวจสอบจำนวนค่าต่างๆในแต่ละ card
    ...
    partner_dashboard_feature.Verify "value" in "Total items" card

Dashboard_ReplyRequestPremiumflow(Partner) - ตอบกลับ รายการสอบถามเบี้ย โดย "ยกเลิก"
    Close All Browsers
    ...
    common.Click (Partner) Dashboard tab
    partner_dashboard_feature.Verify "all values" in "Request premium" dashboard feed list
    partner_dashboard_feature.Click "Reply" in Action button
...
Dashboard_ReplyRequestPremiumflow(Partner) - ตอบกลับ รายการสอบถามเบี้ย โดย "ข้อมูลเพิ่มเติม"
    Close All Browsers
    # create request premium for this case
    common.Access to Check Premium application (Okta Alpha/Beta)                                            ${value.email}   ${value.password}   ${value.okta_url}   ${xpath.email_inputField}   ${xpath.password_inputField}   ${xpath.tisco_signIn_button}   ${value.checkPremium}
    request_premium_feature.Click request premium form tab & Select New customer
...
Dashboard_ReplyRequestPremiumflow(Partner) - ตอบกลับ รายการสอบถามเบี้ย โดย "ไม่รับประกัน"
    Close All Browsers
    # create request premium for this case
    common.Access to Check Premium application (Okta Alpha/Beta)                                            ${value.email}   ${value.password}   ${value.okta_url}   ${xpath.email_inputField}   ${xpath.password_inputField}   ${xpath.tisco_signIn_button}   ${value.checkPremium}
    request_premium_feature.Click request premium form tab & Select New customer
...
Dashboard_ReplyRequestPremiumflow(Partner) - ตอบกลับ รายการสอบถามเบี้ย โดย "รับประกัน"
    Close All Browsers
    # create request premium for this case
    common.Access to Check Premium application (Okta Alpha/Beta)                                                ${value.email}   ${value.password}   ${value.okta_url}   ${xpath.email_inputField}   ${xpath.password_inputField}   ${xpath.tisco_signIn_button}   ${value.checkPremium}
    request_premium_feature.Click request premium form tab & Select New customer

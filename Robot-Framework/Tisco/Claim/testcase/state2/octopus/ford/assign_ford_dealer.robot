...
${value.email}      atiwit_ford@tisco.co.th
...
${value_delete_dealer.group_name}       FORD Assistance
${value_delete_dealer.assign_tag}       N205
@{value_delete_dealer.member_name}      atiwit_ford@tisco.co.th

# # # || ----- Value Add member Input ----- ||
${value_assign_dealer.group_name}       FORD Assistance
${value_assign_dealer.assign_tag}       N203
@{value_assign_dealer.member_name}      atiwit_ford@tisco.co.th

...
${partner_input_list.uw_no}                                 UW-123121200004
${partner_input_list.year_range_date}                       2023
${partner_input_list.month_range_date}                      December
...
${partner_reply_warranty_input.Liability_to_third_parties_life_body_health_per_person}              123350
${partner_reply_warranty_input.Liability_to_third_parties_life_body_health_per_time}                154860
${partner_reply_warranty_input.Liability_to_third_party_property_per_time}                          354800
${partner_reply_warranty_input.first_part_damage_to_third_party_property_per_time}                  298580
...
${partner_reply_warranty_input.Personal_accidents_death_loss_of_organs_and_permanent_disability}    452000
...
${input_form.year_campaign_effective_date}                  2023
${input_form.month_campaign_effective_date}                 December
...
RequestPremiumList_ReplyRequestPremiumflow(Partner) - ตอบกลับ รายการสอบถามเบี้ย โดย "ข้อมูลเพิ่มเติม"
    ...
    partner_request_premium_list_details_page.Verify "Request additional info request premium" modal and Close "Successfully replying" modal
...
RequestPremiumList_ReplyRequestPremiumflow(Partner) - ตอบกลับ รายการสอบถามเบี้ย โดย "รับประกัน"
    ...
    partner_request_premium_list_feature.Fill (Warranty) Section: Insurance premium details                     ${partner_reply_warranty_input.special_campaign}   ${partner_reply_warranty_input.coverage_amount_od}   ${partner_reply_warranty_input.voluntary_car_insurance_premiums}   ${partner_reply_warranty_input.gross_premium}
...
# # ||----- Action button by partner request premium flow -----||
RequestPremiumList_ActionButtonflow(Partner) - กด "ดูรายการ" จาก ปุ่ม 3 จุด ของรายการสอบถามเบี้ย ฝั่ง Partner
    # partner_request_premium_list_feature.(Partner) Search Request Premium list by "UW No."          ${partner_input_list.uw_no}
    Close All Browsers
    # create request premium for this case
    common.Access to Check Premium application (Okta Alpha/Beta)                                                ${value.email}   ${value.password}   ${value.okta_url}   ${xpath.email_inputField}   ${xpath.password_inputField}   ${xpath.tisco_signIn_button}   ${value.checkPremium}

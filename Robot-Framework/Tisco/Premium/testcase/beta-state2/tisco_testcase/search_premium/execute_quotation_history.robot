...
${input_quotation.uw_no}                UW-123090400013
...
${input_quotation.day_created_date}     4
...
QuotationHistory_ViewingDetail - ดูรายละเอียดความคุ้มครองใบเสนอราคา โดยการกด view button
    quotation_history_feature.View quotation history detail by click view button   ${value.brand_name}   ${value.main_model}   ${value.sub_brand}   ${value.car_year}   ${value.car_power}   ${value.car_type}   ${value.gross_code}

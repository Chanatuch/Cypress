...
*** Variables ***
${payment_page.scrollable_element}    xpath=//*[@class="horizontal"]
...
*** Keywords ***
Scroll down consent
    common.Scroll Div to position    ${payment_page.scrollable_element}    0    400
...
Fill credit card field
    [Arguments]    ${cc_number}
    SeleniumLibrary.Wait Until Element Is Visible    ${payment_page.credit_card_field}

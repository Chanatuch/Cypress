...
*** Test Cases ***
zcp tisco insure website
    select_insurance_feature.Fill information and select product zcp  ${test_zcp.birthdate.day}  ${test_zcp.birthdate.month}  ${test_zcp.birthdate.year}
